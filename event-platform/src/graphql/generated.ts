...
export type GeLessonBySlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GeLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };
...
export const GeLessonBySlugDocument = gql`
    query GeLessonBySlug($slug: String) {
...
/**
 * __useGeLessonBySlugQuery__
 *
 * To run a query within a React component, call `useGeLessonBySlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGeLessonBySlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGeLessonBySlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGeLessonBySlugQuery(baseOptions?: Apollo.QueryHookOptions<GeLessonBySlugQuery, GeLessonBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GeLessonBySlugQuery, GeLessonBySlugQueryVariables>(GeLessonBySlugDocument, options);
      }
export function useGeLessonBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GeLessonBySlugQuery, GeLessonBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GeLessonBySlugQuery, GeLessonBySlugQueryVariables>(GeLessonBySlugDocument, options);
        }
export type GeLessonBySlugQueryHookResult = ReturnType<typeof useGeLessonBySlugQuery>;
export type GeLessonBySlugLazyQueryHookResult = ReturnType<typeof useGeLessonBySlugLazyQuery>;
export type GeLessonBySlugQueryResult = Apollo.QueryResult<GeLessonBySlugQuery, GeLessonBySlugQueryVariables>;
